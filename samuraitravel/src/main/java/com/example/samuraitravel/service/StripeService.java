	...
	public String createStripeSession(ReservationDTO reservationDTO, User user) {
		...
		SessionCreateParams sessionCreateParams = SessionCreateParams.builder()
				...
				.addLineItem(SessionCreateParams.LineItem.builder().setPriceData(SessionCreateParams.LineItem.PriceData
						...
						.setUnitAmount(unitAmount).setCurrency(CURRENCY).build()).setQuantity(QUANTITY).build())
				.setMode(MODE).setSuccessUrl(stripeSuccessUrl).setCancelUrl(stripeCancelUrl)
				.setPaymentIntentData(SessionCreateParams.PaymentIntentData.builder().putMetadata("houseId", houseId)
						.putMetadata("userId", userId).putMetadata("checkinDate", checkinDate)
						.putMetadata("checkoutDate", checkoutDate).putMetadata("numberOfPeople", numberOfPeople)
						.putMetadata("amount", amount).build())
				.build();
